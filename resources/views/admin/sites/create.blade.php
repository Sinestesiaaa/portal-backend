<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto px-6 py-10 space-y-6">
        ...
        <div class="bg-gradient-to-r from-[#0AA03A] to-[#16A34A] text-white p-6 rounded-xl shadow-md">
            <h1 class="text-2xl font-bold tracking-wide">Tambah Site</h1>
            <p class="text-white/90 text-sm">Buat site baru</p>
        </div>

        <div class="bg-white p-6 rounded-xl shadow-md border">
            <form action="{{ route('admin.sites.store') }}" method="POST" class="space-y-5">
                @csrf
